...
export default function MergedCommand({ base = 'main', dryRun, verbose, yes }) {
    const [stage, setStage] = useState('loading');
    const [mergedWorktrees, setMergedWorktrees] = useState([]);
    ...
    if (hasNoTargets) {
        return React.createElement(Text, { color: "green" },
            "\u2713 No merged branch worktrees found (base: ",
            base,
            ")");
    }
    ...
    if (isDisplayStage) {
        ...
        return (React.createElement(Box, { flexDirection: "column" },
            React.createElement(Text, { color: "yellow" },
                ...
                " worktrees with branches merged to ",
                base,
                ":"),
            React.createElement(WorktreeTable, { worktrees: mergedWorktrees, verbose: verbose }),
...
//# sourceMappingURL=MergedCommand.js.map